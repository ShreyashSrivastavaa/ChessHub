    ...
    >
      ...
      {nextClass ? (
        ...
        <EmptyState
          ...
          description="Reserve a 1:1 slot with Shreyash or Tapesnu to start your chess progression."
          ...
          <div>
            ...
            {pendingHomework.length > 0 ? (
              ...
              <p className="text-[14px] text-[#323232] py-4">
                Nothing assigned. After your next class, Shreyash or Tapesnu may add a few positions to work through.
              </p>
            )}
          </div>
        </Card>
