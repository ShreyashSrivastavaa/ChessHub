...
Deep obsidian screen `#000000`. Huge 96px light serif display letters fade into crisp focus:
...
## Outro / punchline
The academy seal settles in pure paper white on obsidian:
**"TWO ROOKS"**
...
## Tone
- Preset: `polished`
- Creative direction: "Quiet gallery-grade product film for an elite chess academy"
- Interpretation: Restrained, elegant pacing, immaculate typography, razor-sharp monochrome contrast, zero gimmicks.

## Format: landscape — 1920x1080
## Duration: 18.0 seconds

## Visual identity (from the project)
- Background: `#000000` (Obsidian canvas)
- Elevated surfaces: `#1d1d1d` (Charcoal)
- Primary text: `#ffffff` (Paper White)
- Accent / Subtext / Borders: `#d6d5d0` (Ash)
- Display font: `Newsreader` (light serif 300, 72–116px)
- Body font: `Inter` (300/400 grotesque)
...
- SFX posture: Sparse, tactile clicks and gentle whooshes for card entries and board moves
- Audio-coupled moments: Piece placement click at 2.0s, card slide at 4.6s, Meet button illumination at 10.5s
- Restraint rule: No harsh buzzers, gamey chimes, or hyperactive SFX

## Storyboard

### Scene 1 — The Monograph Hook — 4.5s (0.0s - 4.5s)
Deep obsidian `#000000` canvas. Light serif title "TWO ROOKS" enters with high tracking.
Text appears: *"One coach. One student. One board."*
Wireframe chess glyphs (♔ ♜) emerge in muted ash `#d6d5d0`.
Sequential: Headline settles, subhead slides up, pill badge "ONLINE CHESS ACADEMY" illuminates.
Audio intent: Low atmospheric swell with gentle beat entry at 0.8s.
Transition mood: Seamless fade & scale into Scene 2 at 4.5s.
...
Transition mood: Smooth horizontal tracking into Scene 3 at 9.0s.

### Scene 3 — Live Classroom & Mastery — 5.0s (9.0s - 14.0s)
Editorial dashboard preview featuring:
- Dark 8x8 interactive chessboard in mid-game position.
- "Google Meet: Live in 08m 42s" glowing join button.
- 4-Square Skill Progress matrix: `Introduced` → `Developing` → `Reliable` → `Fluent`.
- Rating performance sparkline in ash & white.
Sequential: Board renders at 9.2s, Meet pill activates at 10.5s, skill ranks fill at 11.8s.
Audio intent: Confident groove highlighting platform capability.
Transition mood: Elegant dissolve to final brand lockup at 14.0s.

### Scene 4 — The Outro & Invitation — 4.0s (14.0s - 18.0s)
Minimalist gallery lockup:
